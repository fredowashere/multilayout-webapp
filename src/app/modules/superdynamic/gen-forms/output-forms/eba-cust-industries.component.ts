...
@Component({
    selector: `gen-form-eba-cust-industries`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_INDUSTRIES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="industry-name"
                    label="Industry Name"
                    data-column-name="INDUSTRY_NAME"
                    [ngControl]="form.controls.industryName"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustIndustries {

    form = new FormGroup({
        id: new FormControl<string | null>(null),
        rowVersionNumber: new FormControl<string | null>(null),
        industryName: new FormControl<string | null>(null),
