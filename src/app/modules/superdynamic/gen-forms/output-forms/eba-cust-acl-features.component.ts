...
@Component({
    selector: `gen-form-eba-cust-acl-features`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_ACL_FEATURES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    ...
                    data-column-name="AUTHORIZATION_NAME"
                    [ngControl]="form.controls.authorizationName"
                    [floatingLabel]="true"
                />
                ...
                <app-input
                    ...
                    data-column-name="ACCESS_LEVEL_ID"
                    [ngControl]="form.controls.accessLevelId"
                    [floatingLabel]="true"
                />
                ...
                <app-input
                    name="feature"
                    label="Feature"
                    data-column-name="FEATURE"
                    [ngControl]="form.controls.feature"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustAclFeatures {

    form = new FormGroup({
        id: new FormControl<string | null>(null),
        authorizationName: new FormControl<string | null>(null),
        accessLevelId: new FormControl<string | null>(null),
        feature: new FormControl<string | null>(null),
