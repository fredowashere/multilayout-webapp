...
@Component({
    selector: `gen-form-eba-cust-contact-types`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_CONTACT_TYPES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="contact-type"
                    label="Contact Type"
                    data-column-name="CONTACT_TYPE"
                    [ngControl]="form.controls.contactType"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustContactTypes {
