...
@Component({
    selector: `gen-form-eba-cust-feedback-types`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_FEEDBACK_TYPES</h4>
        </div>
...
export class GenFormEbaCustFeedbackTypes {
