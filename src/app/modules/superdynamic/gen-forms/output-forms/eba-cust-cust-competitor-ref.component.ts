...
@Component({
    selector: `gen-form-eba-cust-cust-competitor-ref`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_CUST_COMPETITOR_REF</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="competitor-id"
                    label="Competitor Id"
                    data-column-name="COMPETITOR_ID"
                    [ngControl]="form.controls.competitorId"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustCustCompetitorRef {

    form = new FormGroup({
        id: new FormControl<string | null>(null),
        customerId: new FormControl<string | null>(null),
        competitorId: new FormControl<string | null>(null),
