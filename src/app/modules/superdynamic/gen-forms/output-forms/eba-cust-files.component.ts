...
@Component({
    selector: `gen-form-eba-cust-files`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_FILES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="file-lastupd"
                    label="File Lastupd"
                    data-column-name="FILE_LASTUPD"
                    [ngControl]="form.controls.fileLastupd"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustFiles {
    ...
    form = new FormGroup({
        ...
        fileLastupd: new FormControl<string | null>(null),
