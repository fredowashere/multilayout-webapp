...
@Component({
    selector: `gen-form-eba-cust-issue-statuses`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_ISSUE_STATUSES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="open-yn"
                    label="Open Yn"
                    data-column-name="OPEN_YN"
                    [ngControl]="form.controls.openYn"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustIssueStatuses {

    form = new FormGroup({
        id: new FormControl<string | null>(null),
        name: new FormControl<string | null>(null),
        details: new FormControl<string | null>(null),
        openYn: new FormControl<string | null>(null),
