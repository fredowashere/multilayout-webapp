...
@Component({
    selector: `gen-form-eba-cust-geographies`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_GEOGRAPHIES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    ...
                    data-column-name="GEOGRAPHY_NAME"
                    [ngControl]="form.controls.geographyName"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustGeographies {

    form = new FormGroup({
        id: new FormControl<string | null>(null),
        rowVersionNumber: new FormControl<string | null>(null),
        geographyName: new FormControl<string | null>(null),
