...
@Component({
    selector: `gen-form-eba-cust-use-case`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_USE_CASE</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="use-case"
                    label="Use Case"
                    data-column-name="USE_CASE"
                    [ngControl]="form.controls.useCase"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustUseCase {

    form = new FormGroup({
        id: new FormControl<string | null>(null),
        rowVersionNumber: new FormControl<string | null>(null),
        useCase: new FormControl<string | null>(null),
