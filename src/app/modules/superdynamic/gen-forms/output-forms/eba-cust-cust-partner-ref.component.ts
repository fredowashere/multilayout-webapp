...
@Component({
    selector: `gen-form-eba-cust-cust-partner-ref`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_CUST_PARTNER_REF</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="partner-id"
                    label="Partner Id"
                    data-column-name="PARTNER_ID"
                    [ngControl]="form.controls.partnerId"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustCustPartnerRef {
