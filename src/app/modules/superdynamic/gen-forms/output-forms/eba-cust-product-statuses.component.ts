...
@Component({
    selector: `gen-form-eba-cust-product-statuses`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_PRODUCT_STATUSES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="is-current-yn"
                    label="Is Current Yn"
                    data-column-name="IS_CURRENT_YN"
                    [ngControl]="form.controls.isCurrentYn"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustProductStatuses {

    form = new FormGroup({
        id: new FormControl<string | null>(null),
        status: new FormControl<string | null>(null),
        description: new FormControl<string | null>(null),
        isCurrentYn: new FormControl<string | null>(null),
