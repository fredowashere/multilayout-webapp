...
@Component({
    selector: `gen-form-eba-cust-reference-types`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_REFERENCE_TYPES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    ...
                    data-column-name="REFERENCE_TYPE"
                    [ngControl]="form.controls.referenceType"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustReferenceTypes {
