...
@Component({
    selector: `gen-form-eba-cust-categories`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_CATEGORIES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    ...
                    [ngControl]="form.controls.category"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustCategories {
