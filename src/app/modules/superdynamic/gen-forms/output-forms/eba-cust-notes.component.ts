...
@Component({
    selector: `gen-form-eba-cust-notes`,
    standalone: true,
...
<div class="container my-5">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0">Form for table EBA_CUST_NOTES</h4>
        </div>
        ...
        <div class="card-body">
            <div class="d-grid gap-3 mb-4">
                ...
                <app-input
                    name="note-date"
                    label="Note Date"
                    data-column-name="NOTE_DATE"
                    [ngControl]="form.controls.noteDate"
                    [floatingLabel]="true"
                />
...
export class GenFormEbaCustNotes {
    ...
    form = new FormGroup({
        ...
        noteDate: new FormControl<string | null>(null),
